...
{
    List<Material> _shapesMaterials;
    List<ShapePosData> _shapePosDatas;
    List<GameObject> _nextShapeView;
    ...
    public ShapeData()
    {
        _shapesMaterials = new List<Material>();
        _shapePosDatas = new List<ShapePosData>();
        _nextShapeView = new List<GameObject>();
